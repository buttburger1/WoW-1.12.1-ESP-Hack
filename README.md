...
-Added combat bot scripting that can be changed with just a text editor! (Make a folder in game directory named Script, in it your character name as a .txt file)    
