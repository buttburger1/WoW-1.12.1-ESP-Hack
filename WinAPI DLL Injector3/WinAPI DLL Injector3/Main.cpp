...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
		...
		if(LOWORD(wParam)==11)
		{
			if(enableLoop == 0)enableLoop = 1;
			else if(enableLoop == 1)enableLoop = 0;
		}


		if(LOWORD(wParam)==15)appendPos = 1;
...
void CreateControls(HWND hwnd)
{
	HWND hLeftLabel = CreateWindowW(L"Static", L"1",//0
		WS_CHILD | WS_VISIBLE, 15, 75, 10, 30, hwnd, (HMENU)6, NULL, NULL);//275,110

	HWND hRightLabel = CreateWindowW(L"Static", L"500",
		WS_CHILD | WS_VISIBLE, 15, 75, 35, 30, hwnd, (HMENU)7, NULL, NULL);//275,110

	hlbl = CreateWindowW(L"Static", L"5", WS_CHILD | WS_VISIBLE,//1
		125, 65, 35, 30, hwnd, (HMENU)8, NULL, NULL);//350,150
	...
	hTrack = CreateWindowW(TRACKBAR_CLASSW, L"Trackbar Control",
		...
		30, 85, 210, 30, hwnd, (HMENU) 9, NULL, NULL);//275,110,170
