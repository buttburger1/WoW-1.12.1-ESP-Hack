		...
		case GAMEOBJECT:
			...
			else
			{
				...
				if(modeselect == 3)
				{
					...
					ReadProcessMemory(phandle, (void*)(firstobj + 0x248), &scanX, sizeof(scanX), 0);
					ReadProcessMemory(phandle, (void*)(firstobj + 0x24C), &scanY, sizeof(scanY), 0);
					ReadProcessMemory(phandle, (void*)(firstobj + 0x250), &scanZ, sizeof(scanZ), 0);
					scanXarray[numscans] = scanX;
					scanYarray[numscans] = scanY;
					scanZarray[numscans] = scanZ;
					//printf("X: %f Y: %f Z: %f\n", scanX, scanY, scanZ);
